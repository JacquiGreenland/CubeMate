...
Here is the photo taken during the 600 second exposure against C4 - it's a single mono frame taken in suburban Bristol through a UVIR luminance filter with low processing - so it is low on detail but shows the lack of star trailing and tightness of the guiding.
