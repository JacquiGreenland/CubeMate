// -------------------------------------------------------------------------------------------------
// Pin map for OnStep MaxESP4 (ESP32-S3-Zero)
#pragma once
...
// Serial2: RX2 Pin GPIO16, TX2 Pin GPIO17
  ...
  #define SERIAL_A_RX	12
  #define SERIAL_A_TX	13
#endif
...
// Use the following settings for any TMC UART driver (TMC2209) that may be present
  ...
  #define SERIAL_TMC_RX         5               // Recieving data
...
#define AUX2_PIN                17               // M3 pin TMC UART RX
#define AUX3_PIN                43              // Home SW for Axis1
#define AUX4_PIN                44               // Home SW for Axis2
#define AUX5_PIN                OFF               // TX0 main USB, etc.
#define AUX6_PIN                OFF                // RX0 main USB, etc.
#define AUX7_PIN                OFF               // Limit SW, PPS, etc.
#define AUX8_PIN                10               // 1-Wire, Status LED, Reticle LED, Tone, etc.
...
// The PEC index sense is a logic level input, resets the PEC index on rising edge then waits for 60 seconds before allowing another reset
  ...
  #define PEC_SENSE_PIN         11               // [input only 36] PEC Sense, analog (A0) or digital (GPIO36)
#endif
...
#define STATUS_LED_ON_STATE HIGH
  ...
  #define STATUS_LED_PIN        7               // Default LED Anode (+)
#endif
...
#define SHARED_ENABLE_PIN       45                // Hint that the enable pins are shared
